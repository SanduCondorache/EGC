...
void Lab4::RenderScene() {
    ...
    glm::vec3 coords1 = modelMatrix * glm::vec4(0, 0, 0, 1);
    modelMatrix *= transform3D::Translate(translateX, translateY, translateZ);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(2.5f, 0.5f, -1.5f);
    glm::vec3 coords2 = modelMatrix * glm::vec4(0, 0, 0, 1);
    modelMatrix *= transform3D::Translate(translateX, translateY, translateZ);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

    float diff = abs(coords1.x - coords2.x);

    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(0.0f + translateX, 0.5f + translateY,
                                          -1.5f + translateZ);
    modelMatrix *= transform3D::Scale(diff, 0.01, 0.01);
