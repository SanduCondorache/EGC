...
void Lab5::Update(float deltaTimeSeconds) {
    ...
    }
    {
        ...
        sq1 = glm::vec4(modelMatrix[0][3], // fourth element of column 0
                        modelMatrix[1][3], // fourth element of column 1
                        modelMatrix[2][3], // fourth element of column 2
                        modelMatrix[3][3]  // fourth element of column 3
        );
...

    {
        ...
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
        sq2 = glm::vec4(modelMatrix[0][3], // fourth element of column 0
                        modelMatrix[1][3], // fourth element of column 1
                        modelMatrix[2][3], // fourth element of column 2
                        modelMatrix[3][3]  // fourth element of column 3
        );
...

    {
        ...
        sq3 = glm::vec4(modelMatrix[0][3], // fourth element of column 0
                        modelMatrix[1][3], // fourth element of column 1
                        modelMatrix[2][3], // fourth element of column 2
                        modelMatrix[3][3]  // fourth element of column 3
        );
...

    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-10, 5, 0));
        RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
    }
...
void Lab5::OnInputUpdate(float deltaTime, int mods) {
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT)) {
        ...
        if (window->KeyHold(GLFW_KEY_W)) {
            ...
            camera->TranslateForward(10 * deltaTime);
        }
    ...
    if (window->KeyHold(GLFW_KEY_1)) {
        ...
        glm::vec3 delta = objPos - cameraTargetPos;
        float error = 0.01f;
        ...
        float dotYaw =
            glm::clamp(glm::dot(flatCurrent, flatDesired), -1.0f, 1.0f);
        ...
        float rotationSpeed = 1.2f * deltaTime;

        if (angleYaw > 0.001f)
            camera->RotateFirstPerson_OY(signYaw *
                                         glm::min(rotationSpeed, angleYaw));
